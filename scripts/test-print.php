...
try {
	...
	foreach ( array( 'stock_line' => 'stock_receipt_lines', 'stock_receipt' => 'stock_receipts', 'drug' => 'drugs', 'supplier' => 'suppliers', 'sale' => 'sales', 'prescription_item' => 'prescription_items', 'prescription' => 'prescriptions', 'patient' => 'patients', 'branch_alpha' => 'branches', 'branch_beta' => 'branches', 'tenant_alpha' => 'tenants', 'tenant_beta' => 'tenants' ) as $key => $table ) {
