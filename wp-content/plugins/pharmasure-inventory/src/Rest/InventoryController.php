...
final class InventoryController {
	...
	public function can_view() { return current_user_can( 'pharmasure_view_inventory' ) ? true : new \WP_Error( 'forbidden', 'Inventory access is required.', array( 'status' => 403 ) ); }
	public function can_manage() { return current_user_can( 'pharmasure_manage_inventory' ) ? true : new \WP_Error( 'forbidden', 'Inventory management access is required.', array( 'status' => 403 ) ); }
	public function can_receive() { return current_user_can( 'pharmasure_manage_stock' ) ? true : new \WP_Error( 'forbidden', 'Stock management access is required.', array( 'status' => 403 ) ); }
